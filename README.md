...
> [!IMPORTANT]
>29/10/25 mod version 2.4.1.4 changelog:

> [!CAUTION]
> This update *should* be save game safe, but ensure you **back up your save** first!

Slightly lowered amount of wild lavender.

Fixed error with 'In Bed' buff for player-crafted beds.

Added Chopping Block, a workstation for prepping rabbits and chickens for cooking, unlocked at workstations level 2.

Slightly decreased damage for melee weapons except knife and knuckles.

Hazmat zombies are now correctly immune to burning damage.

Sawblades and ammo press are now scrappable/smeltable/sellable.

Added recipes for raw rabbits and chickens.

Edited recipes for the beehive and chicken coop.

Changes to zombie wild spawning.

Lowered action skill experience gained for the Physician action skill.


> [!IMPORTANT]
>14/10/25 mod version 2.4.1.3 changelog:

> [!CAUTION]
> This update *should* be save game safe, but ensure you **back up your save** first!

Fixed missing mesh on player-crafted bed.

Changed chicken coop model.

Fixed missing tags in buffs.xml

Added small damage reduction to all melee weapons except knife and knuckles.

Added signalling buff to indicate standing on a bed/bedroll.

Doubled time corpses remain after death.

Added missing tag to legendary sledge.

Slightly increased food and health amount from roast chickens and roast rabbits.

Fixed smelt time for limestone.

Added Intellect mastery level 2 perk effects (vehicle damage/fuel use) to the Grease Moneky perk.

Added ammo dismantling recipes.

Added recipe for bullets casings (clay/zinc/copper) to the forge.

Changed UI for purchaseable crafting skills to make it more clear that they can be unlocked with research papers.

Added Perception mastery steel harvest perk to Salvage Operations action skill.
...
## BLOCKS/WORKSTATIONS
 ...
 - Chicken coop. Catch a wild chicken and place it in a chicken coop to produce eggs. A Heatlamp for speeding up collection and Nesting for increasing quantity can be purchased or looted.
 
 - Beehive. Find a bee in tree stumps by harvesting the stump. Will produce honey over time when placed in a beehive. A Bee Smoker for speeding up collection and a Bee Frame for increasing quantity can be purchased or looted.
